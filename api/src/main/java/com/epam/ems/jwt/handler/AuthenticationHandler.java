...
public class AuthenticationHandler implements AuthenticationSuccessHandler, AuthenticationFailureHandler {
    ...
    private final static String AUTH_FAIL = "auth.fail";
    private final static String AUTH_FAIL_CODE = "30111";
    private final static String AUTH_SUCCESS = "auth.success";
    private final static String AUTH_SUCCESS_CODE = "30200";
